...
def get_model(point_cloud, is_training, bn_decay=None, preprocessing=False):
    ...
    l1_xyz, l1_points, l1_indices = pointnet_sa_module(l0_xyz, l0_points, npoint=512, radius=0.2, nsample=32, mlp=[64,64,128],\
     mlp2=None, group_all=False, is_training=is_training, bn_decay=bn_decay, scope='layer1', use_nchw=True, preprocessing=preprocessing)
    l2_xyz, l2_points, l2_indices = pointnet_sa_module(l1_xyz, l1_points, npoint=128, radius=0.4, nsample=64, mlp=[128,128,256],\
     mlp2=None, group_all=False, is_training=is_training, bn_decay=bn_decay, scope='layer2', preprocessing=preprocessing)
    l3_xyz, l3_points, l3_indices = pointnet_sa_module(l2_xyz, l2_points, npoint=None, radius=None, nsample=None, mlp=[256,512,1024],\
     mlp2=None, group_all=True, is_training=is_training, bn_decay=bn_decay, scope='layer3', preprocessing=preprocessing)
